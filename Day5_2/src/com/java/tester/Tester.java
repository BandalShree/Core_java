			...
			while(!isFalse) {
				try {
					...
					case 1: 
						...
						showRmMang.add(new ShowroomManagement(sc.next(),Colours.valueOf(sc.next().toUpperCase()),sc.nextDouble(),LocalDate.parse(sc.next()),sc.next()));
						if(showRmMang.contains(showRmMang.get(showRmMang.size()-1)))
